...
class UnitInfo extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <AllianceModal
          show={this.state.showAlliance}
          alliance={this.state.alliance}
          handleAllianceClose={() => this.handleAllianceClose()}
        />
        ...
        <Grid container direction="row" justify="center" alignItems="center">
          <Grid item>
            <img
              src={this.state.unit.icon_url}
              alt={this.state.unit.name + " icon"}
            />
          </Grid>
        </Grid>
        <Grid
        ...
        >
          {this.state.unit.alliances.map(alliance => (
            ...
            >
              <img
                className={classes.popoverImage}
                src={alliance.icon_url}
                onClick={() => this.onAllianceClick(alliance)}
                alt={alliance.name + " icon"}
              />
            </Grid>
          ))}
        </Grid>
